...
import (
	"authenticate-service/authenticate/application"
...
func main() {
	...
	level.Info(logger).Log("main", "Starting authentication service...")
	defer level.Info(logger).Log("main", "Exited authentication service...")
